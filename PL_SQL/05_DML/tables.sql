...
set verify off
set heading off
/* start C:\Users\evana\Desktop\IS480\PL_SQL\05_DML\tables.sql */
...
insert into schclasses values (10110,2018,'Fa','IS',380,1,'MW','10:45',190,'Skywalker',32);
insert into schclasses values (10115,2018,'Fa','ACCT',201,2,'TTH','11:45',150,'smith',33);
insert into schclasses values (10120,2018,'Fa','IS',380,2,'MW','9:15',120,'Skywalker',31);
insert into schclasses values (10125,2018,'Fa','MKT',310,3,'MW','11:45',110,'TBA',37);
insert into schclasses values (10130,2018,'Fa','MKT',350,2,'TH','12:30',180,'smith',37);
insert into schclasses values (10135,2018,'Fa','Math',102,1,'MW','12:00',170,'TBA',39);
insert into schclasses values (10140,2018,'Fa','CBA',495,2,'TTH','11:00',200,'smith',26);
insert into schclasses values (10145,2018,'Fa','Math',210,2,'MW','11:00',130,'Skywalker',27);
insert into schclasses values (10150,2018,'Fa','IS',210,3,'TTH','10:00',200,'lee',32);
insert into schclasses values (10155,2018,'Fa','Math',210,2,'TH','11:30',110,'Solo',33);
insert into schclasses values (10160,2018,'Sp','IS',380,2,'TH','9:15',200,'lee',34);
insert into schclasses values (10165,2018,'Sp','IS',210,3,'MW','12:45',110,'Solo',27);
insert into schclasses values (10170,2018,'Sp','MKT',330,2,'MW','12:15',110,'smith',31);
insert into schclasses values (10175,2018,'Sp','MKT',450,1,'MW','10:30',140,'Fett',35);
insert into schclasses values (10180,2018,'Sp','CBA',485,3,'MW','10:15',110,'lee',27);
insert into schclasses values (10185,2018,'Sp','Math',102,2,'TTH','9:45',180,'Skywalker',26);
insert into schclasses values (10190,2018,'Sp','Math',210,3,'MW','10:45',140,'lee',26);
insert into schclasses values (10195,2018,'Sp','IS',300,2,'MW','10:00',190,'Skywalker',34);
insert into schclasses values (10200,2018,'Sp','CBA',495,3,'MW','10:15',100,'jones',33);
insert into schclasses values (10205,2018,'Sp','Math',102,1,'MW','11:15',100,'Fett',26);
insert into schclasses values (10210,2019,'Fa','CBA',493,2,'TH','11:15',150,'Solo',30);
insert into schclasses values (10215,2019,'Fa','Math',210,2,'MW','10:45',110,'Solo',31);
insert into schclasses values (10220,2019,'Fa','ACCT',470,3,'MW','10:00',130,'Solo',38);
insert into schclasses values (10225,2019,'Fa','MKT',310,1,'TH','10:00',120,'jones',37);
insert into schclasses values (10230,2019,'Fa','Math',101,2,'TTH','9:15',170,'lee',28);
insert into schclasses values (10235,2019,'Fa','MKT',350,3,'TTH','10:45',150,'Skywalker',31);
insert into schclasses values (10240,2019,'Fa','IS',480,2,'MW','10:00',170,'TBA',35);
insert into schclasses values (10245,2019,'Fa','CBA',400,2,'MW','9:00',130,'jones',29);
insert into schclasses values (10250,2019,'Fa','Math',210,2,'MW','12:45',150,'Fett',40);
insert into schclasses values (10255,2019,'Fa','IS',380,1,'TTH','9:15',150,'TBA',38);
insert into schclasses values (10260,2019,'Sp','CBA',494,2,'TTH','12:30',190,'lee',29);
insert into schclasses values (10265,2019,'Sp','MKT',210,1,'TTH','11:45',110,'smith',26);
insert into schclasses values (10270,2019,'Sp','ACCT',202,2,'MW','9:30',190,'Fett',37);
insert into schclasses values (10275,2019,'Sp','CBA',401,1,'TTH','12:15',120,'TBA',37);
insert into schclasses values (10280,2019,'Sp','MKT',350,3,'MW','10:00',140,'Fett',32);
insert into schclasses values (10285,2019,'Sp','Math',210,2,'TTH','11:45',110,'Fett',38);
insert into schclasses values (10290,2019,'Sp','CBA',494,3,'MW','11:15',130,'Skywalker',34);
insert into schclasses values (10295,2019,'Sp','CBA',401,1,'TH','9:15',200,'Fett',32);
insert into schclasses values (10300,2019,'Sp','CBA',300,3,'MW','9:00',190,'smith',28);
...
insert into enrollments values (114,10265,null);
...
insert into enrollments values (118,10260,null);
...
insert into enrollments values (111,10260,null);
