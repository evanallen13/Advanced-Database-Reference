...
/* start C:\Users\evana\Desktop\IS480\section_exercises\#16\tables.sql */
...
insert into schclasses values (10110,2014,'Sp','IS','300',1,45);
insert into schclasses values (10115,2014,'Fa','IS','300',2,118);
insert into schclasses values (10120,2014,'Su1','IS','300',3,35);
insert into schclasses values (10125,2014,'Fa','IS','301',1,35);
insert into schclasses values (10130,2014,'Sp','IS','301',2,35);
insert into schclasses values (10135,2014,'Su1','IS','310',1,35);
insert into schclasses values (10140,2014,'Fa','IS','310',2,35);
insert into schclasses values (10145,2014,'Fa','IS','340',1,30);
insert into schclasses values (10150,2014,'Sp','IS','380',1,33);
insert into schclasses values (10155,2014,'Su2','IS','385',1,35);
insert into schclasses values (10160,2014,'Su2','IS','480',1,35);
