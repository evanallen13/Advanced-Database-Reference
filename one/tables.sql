...
insert into students values ('102','Betty',2,null,3.2,'F');
insert into students values ('103','Cindy',3,'IS',2.5,'F');
insert into students values ('104','David',2,'FIN',3.3,'M');
insert into students values ('105','Ellen',1,null,2.8,'M');
...
insert into schclasses values (10165,2013,'Sp','IS','300',1,45);
insert into schclasses values (10170,2013,'Sp','IS','300',2,35);
insert into schclasses values (10175,2013,'Sp','BIO','101',1,35);
insert into schclasses values (10180,2013,'Fa','ACC','300',1,118);
...
insert into enrollments values (101,10165,'F',0);
insert into enrollments values (102,10165,'A',4);
insert into enrollments values (103,10170,'A',4);
